var fs = require('fs');
const todolist = "Was an der Website noch alles zu tun ist.";
try {
...
var commands = {/*
    ...
    "ToDoList": {
        usage: "",
        description: "Der Bot schreibt, was noch gemacht werden sollte.",
        process: function(bot, msg, suffix){ msg.channel.sendMessage(todolist) }
    }
};
